...
## Unreleased
- Fix Markdown rendering classloading: load commonmark extensions via createObject("java", FQCN) and pin org.nibor.autolink transitive dependency (fixes AutolinkExtension not found in CI/Docker)
